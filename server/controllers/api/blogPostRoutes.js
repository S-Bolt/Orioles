...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json({ error: "Error creating blog post", details: error.message });
    }
  }
);
...
router.get("/:id", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error fetching blog post", details: error.message });
  }
});
...
router.delete(
  ...
  async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ error: "Error deleting blog post", details: error.message });
    }
  }
);
