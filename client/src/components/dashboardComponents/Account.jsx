        ...
        <ul className=" flex  space-x-8 ">
          ...
          <li
            className={`flex flex-col items-center cursor-pointer ${
              activeTab === "username" ? "font-bold" : ""
            }`}
            onClick={() => setActiveTab("username")}
          >
            <FingerPrintIcon className="h-6 w-6 text-white" />
            <span className="text-gray-700 hover:text-white">
              Change Username
            </span>
          </li>
          <li
            className={`flex flex-col items-center cursor-pointer ${
              activeTab === "password" ? "font-bold" : ""
            }`}
          ...
          <li
            className={`flex flex-col items-center cursor-pointer ${
              activeTab === "profile picture" ? "font-bold" : ""
            }`}
          ...
          <li
            className={`flex flex-col items-center cursor-pointer ${
              activeTab === "delete account" ? "font-bold" : ""
            }`}
