          ...
          {comments.map((comment) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                >
                  on post:{" "}
                  <span className=" text-sm font-semibold bg-gradient-to-r from-orange-400 to-oriolesOrange bg-clip-text text-transparent transition-all duration-300 ease-in-out hover:from-oriolesOrange hover:to-orange-400">
                    {comment.post?.title || "Ghost Post"}
                  </span>
                </Link>
              </div>
            </li>
